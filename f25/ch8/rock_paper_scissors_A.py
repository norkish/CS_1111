...
def get_valid_input():
    player1_pick = input("ROCK, PAPER, or SCISSORS? ")
    while player1_pick != "ROCK" and player1_pick != "PAPER" and player1_pick != "SCISSORS":
...
if __name__ == '__main__':
    ...
    while continue_playing:
        ...
        continue_playing = input("Wanna play again (Y/N)? ") != "N"
