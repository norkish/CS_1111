...
def update_seat_assignment(_passenger_list, chart):
    ...
    if idx == -1:
        ...
        seat = get_seat()
        passenger[2] = seat
        chart[seat[0]][seat[1]] = passenger[0][0][0] + passenger[0][1][0]
...
def main():
    ...
    seating_chart = [[None] * COL_COUNT for _ in range(ROW_COUNT)]
    ...
    while True:
        ...
        if choice == 1:
            ...
            update_seat_assignment(passenger_list, seating_chart)
        elif choice == 4:
            print("PRINTING SEATING CHART:")
